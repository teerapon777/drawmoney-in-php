...
<div class="container">
  ...
  <div class="row ">
    <div class="col-lg-8 mb-4">
      <br>
      <form action="index.php?content=EditAdd_chk&&id=<?php echo $Userid;?>" method="post" enctype="multipart/form-data" >
...
<div class="control-group form-group ">
  <div class="controls">
    <label>กำหนดสิทธิ</label>
    <select name="Status" id="PreName" class="form-control">
 <?php if($UserType==1)
 {
   ?>
   <option>ผู้ใช้</option>
   <option>ผู้อนุมัติ</option>
   <option>ผู้ดูแลระบบ</option>
   <option>ผู้จ่ายเงิน</option>
   <?php
 }
    if($UserType==2){
      ?>
